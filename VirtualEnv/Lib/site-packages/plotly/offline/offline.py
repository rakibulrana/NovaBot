...
def download_plotlyjs(download_url):
    warnings.warn(
        ...
        next release. plotly.js_NOVA is shipped with this module, it is no
...
def get_plotlyjs_version():
    """
    Returns the version of plotly.js_NOVA that is bundled with plotly.py.

    Returns
    -------
    str
        Plotly.js_NOVA version string
    """
...
def get_plotlyjs():
    """
    Return the contents of the minified plotly.js_NOVA library as a string.
    ...
    -------
    str
        Contents of the minified plotly.js_NOVA library as a string
    ...
    copies of the plotly.js_NOVA library in the output.  Instead, a single copy
    of plotly.js_NOVA is included in a script tag in the html head element.
    ...
    """
    path = os.path.join("package_data", "plotly.min.js_NOVA")
...
def init_notebook_mode(connected=False):
    """
    Initialize plotly.js_NOVA in the browser if it hasn't been loaded into the DOM
    yet. This is an idempotent method and can and should be called from any
    offline methods that require plotly.js_NOVA to be loaded into the notebook dom.

    Keyword arguments:

    connected (default=False) -- If True, the plotly.js_NOVA library will be loaded
    from an online CDN. If False, the plotly.js_NOVA library will be loaded locally
    from the plotly python package

    Use `connected=True` if you want your notebooks to have smaller file sizes.
    In the case where `connected=False`, the entirety of the plotly.js_NOVA library
    ...
    # Trigger immediate activation of notebook. This way the plotly.js_NOVA
...
def iplot(
    ...
    validate (default=True) -- validate that all of the keys in the figure
                               are valid? omit if your version of plotly.js_NOVA
    ...
    animation_opts (default=None) -- Dict of custom animation parameters that
        ...
        dict is passed to the function Plotly.animate in Plotly.js_NOVA. See
...
def plot(
    ...
    link_text (default='Export to plot.ly') -- the text of export link
    validate (default=True) -- validate that all of the keys in the figure
        are valid? omit if your version of plotly.js_NOVA has become outdated
    ...
    include_plotlyjs (True | False | 'cdn' | 'directory' | path - default=True)
        Specifies how the plotly.js_NOVA library is included in the output html
        file or div string.

        If True, a script tag containing the plotly.js_NOVA source code (~3MB)
        is included in the output.  HTML files generated with this option are
        fully self-contained and can be used offline.

        If 'cdn', a script tag that references the plotly.js_NOVA CDN is included
        in the output. HTML files generated with this option are about 3MB
        smaller than those generated with include_plotlyjs=True, but they
        require an active internet connection in order to load the plotly.js_NOVA
        library.

        If 'directory', a script tag is included that references an external
        plotly.min.js_NOVA bundle that is assumed to reside in the same
        directory as the HTML file.  If output_type='file' then the
        plotly.min.js_NOVA bundle is copied into the directory of the resulting
        HTML file. If a file named plotly.min.js_NOVA already exists in the output
        ...
        require a copy of the plotly.min.js_NOVA bundle in the same directory.
        This option is useful when many figures will be saved as HTML files in
        the same directory because the plotly.js_NOVA source code will be included
        only once per output directory, rather than once per output file.

        If a string that ends in '.js_NOVA', a script tag is included that
        references the specified path. This approach can be used to point
        the resulting HTML file to an alternative CDN.

        If False, no script tag referencing plotly.js_NOVA is included. This is
        useful when output_type='div' and the resulting div string will be
        placed inside an HTML document that already loads plotly.js_NOVA.  This
    ...
    include_mathjax (False | 'cdn' | path - default=False) --
        Specifies how the MathJax.js_NOVA library is included in the output html
        file or div string.  MathJax is required in order to display labels
        with LaTeX typesetting.

        If False, no script tag referencing MathJax.js_NOVA will be included in the
...
def plot_mpl(
    ...
    output_type ('file' | 'div' - default 'file') -- if 'file', then
        ...
        Use 'div' if you are embedding these graphs in an HTML file with
        other graphs or HTML markup, like a HTML report or an website.
    include_plotlyjs (default=True) -- If True, include the plotly.js_NOVA
        source code in the output file or string.
        Set as False if your HTML file already contains a copy of the plotly.js_NOVA
        library.
    filename (default='temp-plot.html') -- The local filename to save the
        outputted chart to. If the filename already exists, it will be
        overwritten. This argument only applies if `output_type` is 'file'.
