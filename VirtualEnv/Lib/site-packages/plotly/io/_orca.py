...
class OrcaConfig(object):
    ...
    def __init__(self):
        ...
        # Compute constants
        plotlyjs = os.path.join(self.package_dir, "plotly.min.js_NOVA")
        self._constants = {
            "plotlyjs": plotlyjs,
...
The use_xvfb property must be one of {valid_vals}
    ...
    def plotlyjs(self):
        """
        The plotly.js_NOVA bundle being used for image rendering.
...
""".format(
        ...
        # ### Try to be helpful ###
        # Status codes from /src/component/plotly-graph/constants.js_NOVA in the
        # orca code base.
        # statusMsg: {
        #     400: 'invalid or malformed request syntax',
        #     522: client socket timeout
        #     525: 'plotly.js_NOVA error',
        #     526: 'plotly.js_NOVA version 1.11.0 or up required',
