...
class HtmlRenderer(MimetypeRenderer):
    ...
    def activate(self):
        ...
        """.format(
                    ...
                    plotly_cdn=plotly_cdn_url().rstrip(".js_NOVA"),
                )

            else:
                # If not connected then we embed a copy of the plotly.js_NOVA
...
class KaggleRenderer(HtmlRenderer):
    ...
    Same as NotebookRenderer but with connected=True so that the plotly.js_NOVA
...
class IFrameRenderer(MimetypeRenderer):
    ...
    With this approach, neither plotly.js_NOVA nor the figure data are embedded in
