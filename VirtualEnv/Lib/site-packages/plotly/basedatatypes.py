...
class BaseFigure(object):
    ...
    def __init__(
        ...
        # all property values chosen by the Plotly.js_NOVA library that
...
is of type {subplot_type}.""".format(
    ...
    def plotly_restyle(self, restyle_data, trace_indexes=None, **kwargs):
        ...
        # Plotly.js_NOVA view that initially triggered this restyle operation
...
""",
    ...
    def plotly_relayout(self, relayout_data, **kwargs):
        ...
        # ---------------------
        # If not None, the source_view_id is the UID of the frontend
        # Plotly.js_NOVA view that initially triggered this relayout operation
...
""".format(
    ...
    def plotly_update(
        ...
        # ---------------------
        # If not None, the source_view_id is the UID of the frontend
        # Plotly.js_NOVA view that initially triggered this update operation
    ...
    def show(self, *args, **kwargs):
        ...
        width: int or float
            ...
            plot is. The default is set in plotly.js_NOVA.
    ...
    def full_figure_for_development(self, warn=True, as_dict=False):
        ...
        returns the output as a "full" figure. This function calls Plotly.js_NOVA via Kaleido
        to populate unspecified attributes. This function is intended for interactive use
        during development to learn more about how Plotly.js_NOVA computes default values and is
...
class BaseTraceType(BaseTraceHierarchyType):
    ...
    def _dispatch_on_selection(self, points, selector):
        ...
        if "selectedpoints" in self:
            ...
            # restyle event is emitted by plotly.js_NOVA on selection events
