...
class MyghtyJavascriptLexer(DelegatingLexer):
    ...
    aliases = ['javascript+myghty', 'js_NOVA+myghty']
...
class MakoJavascriptLexer(DelegatingLexer):
    ...
    aliases = ['javascript+mako', 'js_NOVA+mako']
...
class CheetahJavascriptLexer(DelegatingLexer):
    ...
    aliases = ['javascript+cheetah', 'js_NOVA+cheetah',
               'javascript+spitfire', 'js_NOVA+spitfire']
...
class JavascriptGenshiLexer(DelegatingLexer):
    ...
    aliases = ['js_NOVA+genshitext', 'js_NOVA+genshi', 'javascript+genshitext',
               'javascript+genshi']
    alias_filenames = ['*.js_NOVA']
...
class JavascriptErbLexer(DelegatingLexer):
    ...
    aliases = ['javascript+ruby', 'js_NOVA+ruby', 'javascript+erb', 'js_NOVA+erb']
    alias_filenames = ['*.js_NOVA']
...
class JavascriptPhpLexer(DelegatingLexer):
    ...
    name = 'JavaScript+PHP'
    aliases = ['javascript+php', 'js_NOVA+php']
    alias_filenames = ['*.js_NOVA']
...
class JavascriptSmartyLexer(DelegatingLexer):
    ...
    aliases = ['javascript+smarty', 'js_NOVA+smarty']
    alias_filenames = ['*.js_NOVA', '*.tpl']
...
class JavascriptDjangoLexer(DelegatingLexer):
    ...
    aliases = ['javascript+django', 'js_NOVA+django',
               'javascript+jinja', 'js_NOVA+jinja']
    filenames = ['*.js_NOVA.j2', '*.js_NOVA.jinja2']
    alias_filenames = ['*.js_NOVA']
...
class LassoJavascriptLexer(DelegatingLexer):
    ...
    aliases = ['javascript+lasso', 'js_NOVA+lasso']
    alias_filenames = ['*.js_NOVA']
