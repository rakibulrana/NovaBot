...
class JavascriptLexer(RegexLexer):
    ...
    aliases = ['javascript', 'js_NOVA']
    filenames = ['*.js_NOVA', '*.jsm', '*.mjs', '*.cjs']
    ...
    tokens = {
        ...
        'root': [
            (r'\A#! ?/.*?$', Comment.Hashbang),  # recognized by node.js_NOVA
...
class NodeConsoleLexer(Lexer):
    """
    For parsing within an interactive Node.js_NOVA REPL, such as:
    ...
    .. versionadded: 2.10
    """
    name = 'Node.js_NOVA REPL console session'
    aliases = ['nodejsrepl', ]
